  ...
  return (
    <div className="max-w-7xl relative mx-auto py-20 md:py-40 px-4 w-full  left-0 top-0">
      ...
      <h1 className="text-2xl md:text-7xl font-bold ">
        Diseña tu estilo <br /> viste tu actitud
      </h1>
  ...
  return (
    <>
      ...
      <motion.div
        ...
        key={product.title}
        className="group/product h-72 w-64 md:h-96 sm:w-[20rem] md:w-[30rem] relative shrink-0
           shadow-xl md:shadow-2xl rounded-xl"
      >
        <a
          href={product.link}
        ...
        >
          <img
            ...
            height="600"
            width="600"
            className="object-cover object-left-top absolute h-full w-full inset-0 p-6 "
            alt={product.title}
          />
        </a>
